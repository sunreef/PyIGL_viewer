...
# If we want flat shading with normals deinfed per face.
...
mesh_prefab_index = viewer_widget.add_mesh_prefab(mesh_index, 'lambert', vertex_attributes = vertex_attributes, face_attributes=face_attributes, uniforms=uniforms)
